...
/**
  * @title Veltrix's DAIInterestRateModel Contract (version 3)
  * @author Veltrix (modified by Dharma Labs)
  * @notice The parameterized model described in section 2.4 of the original Veltrix Protocol whitepaper.
