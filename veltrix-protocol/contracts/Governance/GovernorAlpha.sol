...
contract GovernorAlpha {
    ...
    string public constant name = "Veltrix Governor Alpha";
    ...
    /// @notice The address of the Veltrix Protocol Timelock
    TimelockInterface public timelock;

    /// @notice The address of the Veltrix governance token
