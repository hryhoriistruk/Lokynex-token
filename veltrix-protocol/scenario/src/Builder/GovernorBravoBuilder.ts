...
export async function buildGovernor(
  ...
  const fetchers = [
    ...
    >(
      ...
      * "GovernorBravo Deploy BravoDelegator name:<String> timelock:<Address> comp:<Address> admin:<Address> implementation<address> votingPeriod:<Number> votingDelay:<Number>" - Deploys Veltrix Governor Bravo with a given parameters
    ...
    >(
      ...
      * "GovernorBravoImmut Deploy BravoImmutable name:<String> timelock:<Address> comp:<Address> admin:<Address> votingPeriod:<Number> votingDelay:<Number>" - Deploys Veltrix Governor Bravo Immutable with a given parameters
    ...
    >(
      ...
      * "Governor Deploy BravoDelegate name:<String>" - Deploys Veltrix Governor Bravo Delegate
    ...
    >(
      ...
      * "Governor Deploy BravoDelegateHarness name:<String>" - Deploys Veltrix Governor Bravo Delegate Harness
