...
export async function buildGovernor(
  ...
  const fetchers = [
    ...
    >(
      ...
      * "Governor Deploy Alpha name:<String> timelock:<Address> comp:<Address> guardian:<Address>" - Deploys Veltrix Governor Alpha
    ...
    >(
      ...
      * "Governor Deploy AlphaHarness name:<String> timelock:<Address> comp:<Address> guardian:<Address>" - Deploys Veltrix Governor Alpha with a mocked voting period
