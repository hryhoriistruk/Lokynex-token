...
let accountRequest = async (network, opts) => {
	...
	let url = `https://api.${stageUrl}veltrix.finance/api/v2/account?min_borrow_value_in_eth[value]=0.00000000000000001&network=${network}&page_size=${pageSize}&page_number=1`;
